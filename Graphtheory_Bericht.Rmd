...
caption = "Boxplot of the Fraction of Xenologs plotted against the HGT rate with a fixed duplication and loss rate. The different colors marking the groups with the same duplication or loss rate."
...
recall_T_LDT <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  annotate(geom="label", x=7.4, y=1, label=24, color="black") +
  theme_bw()
recall_T_LDT
```
...
accuracy_T_LDT <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  ylim(0,0.002) +
  stat_summary(fun.y=mean, geom="point", shape=23, size=3) +
  annotate(geom="label", x=7.4, y=0, label=26, color="black") +
  theme_bw()
accuracy_T_LDT
```
...
recall_S_LDT <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  #ylim(0.99,1.1) +
  stat_summary(fun.y=mean, geom="point", shape=23, size=3) +
  annotate(geom="label", x=7.4, y=1, label=27, color="black") +
  theme_bw()
recall_S_LDT
```
...
precision_S_LDT <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  #ylim(0,0.01) +
  stat_summary(fun.y=mean, geom="point", shape=23, size=3) +
  annotate(geom="label", x=7.4, y=0, label=28, color="black") +
  theme_bw()
precision_S_LDT
```
...
accuracy_S_LDT <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  #ylim(-0.1,1) +
  stat_summary(fun.y=mean, geom="point", shape=23, size=3) +
  annotate(geom="label", x=7.4, y=0, label=29, color="black") +
  theme_bw()
accuracy_S_LDT
```
...
sumTriple_Fraction %>%
  kbl(caption = "Tab. 3: BESCHREIBUNG HIER.") %>%
  kable_classic_2("hover", full_width = F)
```
...
T_Triple_Fraction <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  #ylim(0,0.70) +
  stat_summary(fun=mean, geom="point", shape=23, size=3) +
  annotate(geom="label", x=7.4, y=0, label=30, color="black") +
  theme_bw()
T_Triple_Fraction
```
...
S_Triple_Fraction <- ggplot(treeDataDf, aes(x = as.factor(Group),
  ...
  ylim(0,0.70) +
  stat_summary(fun=mean, geom="point", shape=23, size=3) +
  annotate(geom="label", x=7.4, y=0, label=31, color="black") +
  theme_bw()
S_Triple_Fraction
```