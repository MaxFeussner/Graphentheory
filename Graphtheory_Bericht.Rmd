...
sumCDrecallDf %>%
  kbl(caption = "Tab. 3: Some Caption") %>%
  kable_classic_2("hover", full_width = F)
```
...
sumCDprecisionlDf %>%
  kbl(caption = "Tab. 4: Some Caption") %>%
  kable_classic_2("hover", full_width = F)
```
...
sumCDaccuracyDf %>%
  kbl(caption = "Tab. 5: Some Caption") %>%
  kable_classic_2("hover", full_width = F)
```
...
sumRSrecallDf %>%
  kbl(caption = "Tab. 6: Some Caption") %>%
  kable_classic_2("hover", full_width = F)
```
...
sumRSaccuracyDf %>%
  ...
  kable_classic_2("hover", full_width = F, digits = 2)
```
...
```{r plotCprec, echo = FALSE, message=FALSE, warning=FALSE, fig.cap=caption}}
caption = "Sinvolle beschreibung des Plottes hier"
...
```{r recall_T_LDT, echo = FALSE, message=FALSE, warning=FALSE, fig.cap=caption}}
caption = "Sinvolle beschreibung des Plottes hier"
